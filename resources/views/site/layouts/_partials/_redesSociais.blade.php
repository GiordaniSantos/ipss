...
<ul class="container-redes mb-3 wow fadeInUp" data-wow-delay="0.1s" style="padding:0px;">
    @if($config->spotify)
        <li class="icon-content">
            <a href="{{$config->spotify}}" target="_blank" aria-label="LinkedIn" data-social="linkedin">
                <div class="filled"></div>
                <svg width="16" height="16" fill="currentColor" class="bi bi-linkedin" version="1.1" viewBox="0 0 100 100">
                    <path
    ...
    @if($config->instagram)
        <li class="icon-content">
            <a href="{{$config->instagram}}" target="_blank" aria-label="Instagram" data-social="instagram">
                <div class="filled"></div>
                <svg
    ...
    @if($config->youtube)
        <li class="icon-content">
            <a href="{{$config->youtube}}" target="_blank" aria-label="Youtube" data-social="youtube">
                <div class="filled"></div>
                <svg
                xmlns="http://www.w3.org/2000/svg"
                width="16"
