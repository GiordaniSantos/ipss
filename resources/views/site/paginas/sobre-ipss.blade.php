        ...
        <div class="row g-5 mx-lg-0">
            <div class="col-lg-6 ps-lg-0 wow fadeInLeft" data-wow-delay="0.1s" style="min-height: 400px;">
                <div class="position-relative h-100">
                    <img class="img-fluid w-100 h-100" src="images/historia-ipss-david-maria.jpg" style="object-fit: cover;" alt="">
                </div>
            </div>
    ...
    <div class="container feature py-5 px-lg-0">
        <div class="row g-5 mx-lg-0">
            ...
            <div class="col-lg-6 pe-lg-0 wow fadeInRight" data-wow-delay="0.1s" style="min-height: 400px;">
                <div class="position-relative h-100">
                    <img class="img-fluid w-100 h-100" src="images/historia-ipss2.jpeg" style="object-fit: cover;" alt="">
                </div>
            </div>
        </div>
    </div>
...
<div class="container-fluid overflow-hidden py-5 px-lg-0">
    <div class="container about py-5 px-lg-0">
        <div class="row g-5 mx-lg-0">
            <div class="col-lg-6 ps-lg-0 wow fadeInLeft" data-wow-delay="0.1s" style="min-height: 400px;">
                <div class="position-relative h-100">
                    <img class="img-fluid w-100 h-100" src="images/historia-ipss3.jpg" style="object-fit: cover;" alt="">
                </div>
            </div>
            <div class="col-lg-6 about-text wow fadeInUp d-flex" style="align-items: center;" data-wow-delay="0.3s">
                <div>
...
<div class="container-fluid overflow-hidden py-5 px-lg-0">
    <div class="container feature py-5 px-lg-0">
        <div class="row g-5 mx-lg-0">
            ...
            <div class="col-lg-6 pe-lg-0 wow fadeInRight" data-wow-delay="0.1s" style="min-height: 400px;">
                <div class="position-relative h-100">
                    <img class="img-fluid w-100 h-100" src="images/historia-ipss4.jpg" style="object-fit: cover;" alt="">
                </div>
            </div>
        </div>
    </div>
...
<div class="container-fluid overflow-hidden py-5 px-lg-0">
    <div class="container about py-5 px-lg-0">
        <div class="row g-5 mx-lg-0">
            <div class="col-lg-6 ps-lg-0 wow fadeInLeft" data-wow-delay="0.1s" style="min-height: 400px;">
                <div class="position-relative h-100">
                    <img class="img-fluid w-100 h-100" src="images/historia-ipss5.jpg" style="object-fit: cover;" alt="">
                </div>
            </div>
            <div class="col-lg-6 about-text wow fadeInUp d-flex" style="align-items: center;" data-wow-delay="0.3s">
                <div>
...
<div class="container-fluid overflow-hidden py-5 px-lg-0">
    <div class="container feature py-5 px-lg-0">
        <div class="row g-5 mx-lg-0">
            ...
            <div class="col-lg-6 pe-lg-0 wow fadeInRight" data-wow-delay="0.1s" style="min-height: 400px;">
                <div class="position-relative h-100">
                    <img class="img-fluid w-100 h-100" src="images/historia-ipss7.jpg" style="object-fit: cover;" alt="">
                </div>
            </div>
        </div>
    </div>
...
<div class="container-fluid overflow-hidden py-5 px-lg-0">
    <div class="container about py-5 px-lg-0">
        <div class="row g-5 mx-lg-0">
            <div class="col-lg-6 ps-lg-0 wow fadeInLeft" data-wow-delay="0.1s" style="min-height: 400px;">
                <div class="position-relative h-100">
                    <img class="img-fluid w-100 h-100" src="images/historia-ipss.jpeg" style="object-fit: cover;" alt="">
                </div>
            </div>
            <div class="col-lg-6 about-text wow fadeInUp d-flex" style="align-items: center;" data-wow-delay="0.3s">
                <div>
        ...
        <div class="row g-5 mx-lg-0">
            <div class="col-lg-6 feature-text wow fadeInUp d-flex" style="align-items: center;" data-wow-delay="0.1s">
                <div>
                    ...
                    <p>Em janeiro de 1988 o pastor Levi F. da Silva assumiu o cargo de pastor da igreja, permanecendo neste ministério até junho de 1989.</p>
                </div>
            </div>
            <div class="col-lg-6 pe-lg-0 wow fadeInRight" data-wow-delay="0.1s" style="min-height: 400px;">
                <div class="position-relative h-100">
                    <img class="img-fluid w-100 h-100" src="images/historia-ipss8.jpg" style="object-fit: cover;" alt="">
                </div>
            </div>
        </div>
    </div>
...
<div class="container-fluid overflow-hidden py-5 px-lg-0">
    <div class="container about py-5 px-lg-0">
        <div class="row g-5 mx-lg-0">
            <div class="col-lg-6 ps-lg-0 wow fadeInLeft" data-wow-delay="0.1s" style="min-height: 400px;">
                <div class="position-relative h-100">
                    <img class="img-fluid w-100 h-100" src="images/historia-ipss9.jpg" style="object-fit: cover;" alt="">
                </div>
            </div>
            <div class="col-lg-6 about-text wow fadeInUp d-flex" style="align-items: center;" data-wow-delay="0.3s">
                <div>
                    <h1 class="mb-5">Pastor Henry Matthew Haswell Jr.</h1>
                    <p class="mb-5">De 1989 a 1993, o senhor Henry Matthew Haswell Jr. assumiu o pastorado da igreja.</p>
                </div>
            </div>
        </div>
    </div>
...
<div class="container-fluid overflow-hidden py-5 px-lg-0">
    <div class="container feature py-5 px-lg-0">
        <div class="row g-5 mx-lg-0">
            ...
            <div class="col-lg-6 pe-lg-0 wow fadeInRight" data-wow-delay="0.1s" style="min-height: 400px;">
                <div class="position-relative h-100">
                    <img class="img-fluid w-100 h-100" src="images/historia-ipss10.jpg" style="object-fit: cover;" alt="">
                </div>
            </div>
        </div>
    </div>
...
<div class="container-fluid overflow-hidden py-5 px-lg-0">
    <div class="container about py-5 px-lg-0">
        <div class="row g-5 mx-lg-0">
            <div class="col-lg-6 ps-lg-0 wow fadeInLeft" data-wow-delay="0.1s" style="min-height: 400px;">
                <div class="position-relative h-100">
                    <img class="img-fluid w-100 h-100" src="images/historia-ipss11.jpg" style="object-fit: cover;" alt="">
                </div>
            </div>
            <div class="col-lg-6 about-text wow fadeInUp d-flex" style="align-items: center;" data-wow-delay="0.3s">
                <div>
        ...
        <div class="row g-5 mx-lg-0">
            ...
            <div class="col-lg-6 about-text wow fadeInUp d-flex" style="align-items: center;" data-wow-delay="0.3s">
                <div>
                    ...
                    <p class="mb-5">De janeiro a dezembro de 2002 foi o senhor Josinaldo C. Nascimento quem pastoreou nossa igreja e, de janeiro a dezembro de 2003, o senhor Antônio Paulo M. de Oliveira assumiu o ministério pastoral da igreja de Sapucaia.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row g-5 mx-lg-0">
            <div class="col-lg-6 feature-text wow fadeInUp d-flex" style="align-items: center;" data-wow-delay="0.1s">
                <div>
                    ...
                    <p>Em janeiro de 2004 assumiu o pastor Paulo Roberto Magalhães com sua esposa Isabel. Ele foi responsável pela colocação do piso e do reboco interno e pastoreou a igreja até 2008.</p>
                </div>
            </div>
            <div class="col-lg-6 pe-lg-0 wow fadeInRight" data-wow-delay="0.1s" style="min-height: 400px;">
                <div class="position-relative h-100">
                    <img class="img-fluid w-100 h-100" src="images/historia-ipss14.jpg" style="object-fit: cover;" alt="">
                </div>
            </div>
        </div>
    </div>
...
<div class="container-fluid overflow-hidden py-5 px-lg-0">
    <div class="container about py-5 px-lg-0">
        <div class="row g-5 mx-lg-0">
            <div class="col-lg-6 ps-lg-0 wow fadeInLeft" data-wow-delay="0.1s" style="min-height: 400px;">
                <div class="position-relative h-100">
                    <img class="img-fluid w-100 h-110" src="images/historia-ipss15.jpg" style="object-fit: cover;" alt="">
                </div>
            </div>
            <div class="col-lg-6 about-text wow fadeInUp d-flex" style="align-items: center;" data-wow-delay="0.3s">
                <div>
                    <h1 class="mb-5">Pastor Domingos Orlando da Silva</h1>
                    <p class="mb-5">Em 2009, o Rev. Domingos Orlando da Silva assumiu a liderança da igreja, dando continuidade aos trabalhos. Ele permaneceu no cargo de pastor até 2010.</p>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="row g-5 mx-lg-0">
            <div class="col-lg-6 feature-text wow fadeInUp d-flex" style="align-items: center;" data-wow-delay="0.1s">
                <div>
                    ...
                    <p>
                        Após a saída do Rev. Domingos, o pastor Edvaldo Xavier Gomes assumiu a liderança da igreja, acompanhado por sua esposa. Ele pastoreou a igreja de 2010 até 2017. 
...
<div class="container-fluid overflow-hidden py-5 px-lg-0">
    <div class="container about py-5 px-lg-0">
        <div class="row g-5 mx-lg-0">
            <div class="col-lg-6 ps-lg-0 wow fadeInLeft" data-wow-delay="0.1s" style="min-height: 400px;">
                <div class="position-relative h-100">
                    <img class="img-fluid w-100 h-100" src="images/pastor2.jpg" style="object-fit: cover;" alt="">
                </div>
            </div>
            <div class="col-lg-6 about-text wow fadeInUp d-flex" style="align-items: center;" data-wow-delay="0.3s">
                <div>
        ...
        <div class="row g-5 mx-lg-0">
            <div class="col-lg-6 feature-text wow fadeInUp d-flex" style="align-items: center;" data-wow-delay="0.1s">
                <div>
                    ...
                    <p>
                        Este texto foi <em>adaptado por Jean Pereira Zeni</em>, com base no texto original <em>escrito pelo irmão Presb. Hemérito Sr. Jorge David Machado que fez sua pública profissão de fé, batismo e casamento também nesta mesma igreja.</em>
            ...
            <div class="col-lg-6 pe-lg-0 wow fadeInRight" data-wow-delay="0.1s" style="min-height: 400px;">
                <div class="position-relative h-100">
                    <img class="img-fluid w-100 h-100" src="images/presbiteroJorge.jpg" style="object-fit: cover;" alt="">
                </div>
            </div>
        </div>
    </div>
